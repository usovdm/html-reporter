...
/////
export const suiteBegin2 = (suite) => ({type: actionNames.SUITE_BEGIN_2, payload: suite});
export const testBegin2 = (test) => ({type: actionNames.TEST_BEGIN_2, payload: test});
export const testResult2 = (result) => ({type: actionNames.TEST_RESULT_2, payload: result});
/////
