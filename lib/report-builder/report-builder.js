...
const ResultsTreeBuilder = require('./results-tree-builder');
...
module.exports = class ReportBuilder {
    ...
    constructor(hermione, pluginConfig) {
        ...
        this._resultsTree = ResultsTreeBuilder.create();
        this._skips = [];
        this._browsers = [];
    ...
    _getResultNode(formattedResult) {
        ...
        // this._resultsTree.addSuites(suitePath);
    ...
    _initNode(node, formattedResult, testResult) {
        ...
        // const {suite} = formattedResult;
        // const suitePath = suite.path.concat(formattedResult.state ? formattedResult.state.name : NO_STATE);
        this._resultsTree.addTestResult(testResult, formattedResult);
    ...
    getResult() {
        ...
        const oldSuites = this._tree.children;
        const newSuites = this._resultsTree.toOldFormat();
